"""Train JointDiffusion on LOBSTER generated order book data within Penny workspace setup.

Usage::
    uv run python src/stocks/feishu/train_jointdiff_lobster.py --config configs/stocks/feishu/jointdiff_lobster_ofi.json
"""
...
from src.models.jointdiff import JointDiffusion, count_parameters
...
def main() -> None:
    ...
    if not config_path.exists():
        logger.error("config not found at: {}", config_path)
        sys.exit(1)
